...
import { getOrderList, getProductList, getKnowledgeList, getAgentConfig } from "./dashboard.service";
...
export default async function Dashboard() {
  ...
  const agentConfig = await getAgentConfig(userInfo.guildId);
  ...
  return (
    ...
    >
      <div className="p-2 border-b bg-gradient-to-br from-primary/30 to-slate-950 rounded-md">
        <Header agentConfig={agentConfig} guildId={userInfo.guildId} />
      </div>
