...
export const metadata: Metadata = {
  ...
  description: 'Your Complete Discord eCommerce Solution. Everything you need to sell in Discord.',
  keywords: 'discord bot, ecommerce, discord shop, discord store, selling on discord',
